...
type DNSResponse struct {
	...
	DnsRecord *DNSRecord `protobuf:"bytes,2,opt,name=dnsRecord,proto3,oneof" json:"dnsRecord,omitempty"`
}

func (x *DNSResponse) Reset() {
	*x = DNSResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dnscommand_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DNSResponse) Descriptor() ([]byte, []int) {
	return file_dnscommand_proto_rawDescGZIP(), []int{2}
}
...
func (x *DNSResponse) GetDnsRecord() *DNSRecord {
	if x != nil {
		return x.DnsRecord
	}
	return nil
...
var file_dnscommand_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x0a, 0x72, 0x61, 0x66, 0x74, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x1a, 0x1f,
	...
	,
}
...
var file_dnscommand_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dnscommand_proto_goTypes = []interface{}{
	(*DNSCommand)(nil),            // 0: raftprotos.DNSCommand
	(*DNSRecord)(nil),             // 1: raftprotos.DNSRecord
	(*DNSResponse)(nil),           // 2: raftprotos.DNSResponse
	(*durationpb.Duration)(nil),   // 3: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_dnscommand_proto_depIdxs = []int32{
	3, // 0: raftprotos.DNSCommand.ttl:type_name -> google.protobuf.Duration
	3, // 1: raftprotos.DNSRecord.ttl:type_name -> google.protobuf.Duration
	4, // 2: raftprotos.DNSRecord.added:type_name -> google.protobuf.Timestamp
	1, // 3: raftprotos.DNSResponse.dnsRecord:type_name -> raftprotos.DNSRecord
...
func file_dnscommand_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_dnscommand_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_dnscommand_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
