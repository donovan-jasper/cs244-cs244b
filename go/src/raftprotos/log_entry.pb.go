...
type LogEntry struct {
	...
	CommandId  int32  `protobuf:"varint,6,opt,name=commandId,proto3" json:"commandId,omitempty"`
}
...
func (x *LogEntry) GetClientAddr() string {
	if x != nil {
		return x.ClientAddr
	}
	return ""
...
func (x *LogEntry) GetClientPort() int32 {
	if x != nil {
		return x.ClientPort
	}
	return 0
...
func (x *LogEntry) GetCommandId() int32 {
	if x != nil {
		return x.CommandId
	}
	return 0
...
var file_log_entry_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x0a, 0x72, 0x61, 0x66, 0x74, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x22, 0xac, 0x01,
	...
	0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x1e,
	...
	0x28, 0x05, 0x52, 0x0a, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x50, 0x6f, 0x72, 0x74, 0x12, 0x1c,
	0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x49, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x09, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x49, 0x64, 0x42, 0x0e, 0x5a, 0x0c,
	0x2e, 0x2f, 0x72, 0x61, 0x66, 0x74, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_log_entry_proto_goTypes = []interface{}{
	(*LogEntry)(nil), // 0: raftprotos.LogEntry
}
